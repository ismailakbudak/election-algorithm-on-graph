...
class Ui_MainWindow():
    ...
    def setupUi(self, MainWindow): 
        ...
        self.pushButtonGrow.clicked.connect(self.grow) 
        ...
        self.labelNodesCountSettings = QtGui.QLabel(self.tabSettings)
        self.labelNodesCountSettings.setGeometry(QtCore.QRect(30, 10, 350, 30)) 
        self.labelNodesCountSettings.setObjectName(_fromUtf8("labelNodesCountSettings"))
        self.labelNodesCountSettings.setText(_translate("MainWindow", "Number of Nodes : ", None))

        # settings - Grow limit label title
        self.labelNodesGrowLimit = QtGui.QLabel(self.tabSettings)
        self.labelNodesGrowLimit.setGeometry(QtCore.QRect(30, 50, 170, 30)) 
        ...
        self.textEditGrowLimit.setGeometry(QtCore.QRect(180, 50, 200, 30))
        self.textEditGrowLimit.setObjectName(_fromUtf8("textEditGrowLimit")) 
        # settings - Grow limit label title
        self.labelNodesGrowthRate = QtGui.QLabel(self.tabSettings)
        self.labelNodesGrowthRate.setGeometry(QtCore.QRect(30, 90, 170, 30)) 
        ...
        self.textEditGrowthRate.setGeometry(QtCore.QRect(180, 90, 200, 30))
        ...
        self.labelNodesMaxCapacity.setGeometry(QtCore.QRect(30, 130, 170, 30)) 
        ...
        self.textEditNodeMaxCapacity.setGeometry(QtCore.QRect(180, 130, 200, 30))
        self.textEditNodeMaxCapacity.setObjectName(_fromUtf8("textEditNodeMaxCapacity")) 

        # settings - Clear graph  button
        self.pushButtonClearGraph = QtGui.QPushButton(self.tabSettings)
        self.pushButtonClearGraph.setGeometry(QtCore.QRect(30, 190, 200, 30)) 
        ...
        self.checkBoxTraceElection.setGeometry(QtCore.QRect(30, 230, 300, 30))
        ...
        self.checkBoxTraceGrowth.setGeometry(QtCore.QRect(30, 260, 300, 30))
        ...
        self.checkBoxTraceLog.setGeometry(QtCore.QRect(30, 290, 300, 30))
        ...
        # settings - traceVisual
        self.checkBoxTraceVisual = QtGui.QCheckBox(self.tabSettings)
        self.checkBoxTraceVisual.setGeometry(QtCore.QRect(30, 320, 300, 30))
        self.checkBoxTraceVisual.setObjectName(_fromUtf8("checkBoxTraceVisual"))
        self.checkBoxTraceVisual.setText(_translate("MainWindow", "Result Visualization", None))
        self.checkBoxTraceVisual.setChecked(False)
        # settings - traceGrowthVisual
        self.checkBoxTraceGrowthVisual = QtGui.QCheckBox(self.tabSettings)
        self.checkBoxTraceGrowthVisual.setGeometry(QtCore.QRect(30, 350, 350, 30))
        self.checkBoxTraceGrowthVisual.setObjectName(_fromUtf8("checkBoxTraceGrowthVisual"))
        self.checkBoxTraceGrowthVisual.setText(_translate("MainWindow", "Growth Result Visualization Step By Step", None))
    ...
    def grow(self):
        ...
        GROWTH_RATE = int( str( self.textEditGrowthRate.text()      ))  
        GROWTH_LIMIT= int( str( self.textEditGrowLimit.text()       ))  
        MAX_CAPACITY= int( str( self.textEditNodeMaxCapacity.text() )) 
        self.graph.grow( GROWTH_RATE, GROWTH_LIMIT, MAX_CAPACITY)    
        self.fill_fields()
        self.draw()
    ...
    def startElection(self):
        ...
        if start:
            ...
            self.labelNodesCount.setText("There is no start node..")
            self.labelNodesCountSettings.setText("There is no start node..")

    def draw(self):
        self.set_graph_trace()
        if self.graph.traceVisual:
            self.graph.draw()
    ...
    def set_labels(self):
        ...
        self.labelNodesCountSettings.setText(  "Number of Nodes : %s" % ( str(num) ) )
    ...
    def set_graph_trace(self):
        ...
        if self.checkBoxTraceVisual.isChecked():
            self.graph.traceVisual = True
        else:
            self.graph.traceVisual = False
    ...
    def set_check_box(self):
        ...
        if self.graph.traceVisual:
            self.checkBoxTraceVisual.setChecked(True)
        else:
            self.checkBoxTraceVisual.setChecked(False)
